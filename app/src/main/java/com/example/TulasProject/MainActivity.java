...
/*        getMenuInflater().inflate(R.menu.current_place_menu, menu);
    ...
    public boolean onOptionsItemSelected(MenuItem item)
  {
      ...
      {
          Intent i = new Intent(getBaseContext(),add_user.class);
          //Set the Data to pass
          String get_location = location1;
          i.putExtra("txtData", get_location);
          startActivity(i);
      }
                ...
                locationResult.addOnCompleteListener(this, new OnCompleteListener<Location>() {
                    ...
                    public void onComplete(@NonNull Task<Location> task) {
                        if (task.isSuccessful()) {
                            ...
                            longi = String.valueOf(mLastKnownLocation.getLongitude());
                            lati = String.valueOf(mLastKnownLocation.getLatitude());
                            location = "Current Location : \n" + "Longitude : "+ longi + " " +"\nLatitude : "+ lati;
                            location1 = "Longitude :"+longi +  "  "+ "Latitude :"+ lati;
